...
from state
WHERE (state_abbreviation !='AS' OR state_abbreviation != 'GU' OR state_abbreviation != 'MP'
OR state_abbreviation != 'PR' OR state_abbreviation != 'VI') AND census_region IS NOT NULL
